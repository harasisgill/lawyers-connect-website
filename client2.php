       ...
       <script>
        ...
        myapp.controller("mycontroller", function($scope, $http) {
            ...
            $scope.doFetchJson = function() {
               // alert("Hello");
                var xx=document.getElementById("col").value;
                //alert(xx);
                $http.get("json-fetch-all.php?lt="+xx).then(shanti, noshanti);
...
<body ng-app="app" ng-controller="mycontroller">
   <nav class="navbar navbar-light bg-light">
    ...
    <div class="container" id="BB">
        <div class="col-md-4">
            <h1><label id="SU">Select the type of lawyer</label></h1>
        </div><br>
        ...
        <p>
            <input type="button" name="search" id="search" ng-click="doFetchJson();" value="Search" style=" cursor:pointer; margin-left: 208px;margin-top:100px; background-color: black;color: white;width: 80px;height: 30px;box-shadow: 5px 5px 10px black">
        </p>
        ...
        <table width="650" border=1 style="background-color:black;color:white;margin-left:300px;margin-top:70px">
            <tr>
                <th>Name</th>
                <th>Address</th>
